 ...
 */
public abstract class Sigv4SignerBase {
     ...
     */
    public Sigv4SignerBase(URL endpointUrl, String httpMethod,
    ...
    protected static String getCanonicalizedResourcePath(URL endpoint) {
        ...
        String encodedPath = Sigv4HttpUtils.urlEncode(path, true);
    ...
    public static String getCanonicalizedQueryString(Map<String, String> parameters) {
        ...
        while (pairs.hasNext()) {
            ...
            sorted.put(Sigv4HttpUtils.urlEncode(key, false), Sigv4HttpUtils.urlEncode(value, false));
        }
    ...
    protected static String getStringToSign(String scheme, String algorithm, String dateTime, String scope, String canonicalRequest) {
        String stringToSign =
                        ...
                        dateTime + "\n" +
                        scope + "\n" +
                        Sigv4BinaryUtils.toHex(hash(canonicalRequest));
        return stringToSign;
    }
